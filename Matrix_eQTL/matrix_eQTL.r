...
#covariates_file_name = paste(data.dir, "/data/Covariates.txt", sep="");

# Output file name
output_file_name_cis = paste(data.dir,"/cis_eqtl.txt",sep="");
output_file_name_tra = paste(data.dir,"/trans_eqtl.txt",sep="");

# Only associations significant at this level will be saved
pvOutputThreshold_cis = 1;
pvOutputThreshold_tra = 0.001;
